...
score_button=digitalio.DigitalInOut(board.GP16) #Initalize score_button and attach it to GP3
ball_count_button=digitalio.DigitalInOut(board.GP2) #Initalize ball_count_button and attach it to GP2
...
while True:
    ...
    if score_button.value == False:
        score= score+5
    #Increases ball count value by 1 when pressed
    if ball_count_button.value == False:
        ball_count=ball_count+1# Write your code here :-)
